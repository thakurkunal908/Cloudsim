...
public class ShortestJobFirst {
	...
	public static void main(String[] args) {
		Log.printLine("Starting Shortest Job First(Non Pre emptive)...");
		...
		try {
			...
			vmlist = createVM(brokerId,num_vm); //creating 20 vms
			cloudletList = createCloudlet(brokerId,num_cloudlet,cloudletLength); // creating 40 cloudlets

			//Sorting CloudletList for SSJF
			...
			{
				System.out.println("Index "+i+" holds cloudlet "+cloudletList.get(i).getCloudletId()+" having length "+cloudletList.get(i).getCloudletLength());
			}
			...
			printCloudletList(newList,num_vm);
